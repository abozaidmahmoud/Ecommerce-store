<?php $__env->startSection('section'); ?>
                ...
                <div class="header-icons-mobile">
                    ...
                    <div class="header-wrapicon2">
                        ...
                        <div class="header-cart header-dropdown">
                            ...
                            <div class="header-cart-total">
                                <?php echo e(trans('lang.total')); ?>: $75.00
                            </div>
    ...
    <section class="slide1">
        <div class="wrap-slick1">
            <div class="slick1">
                <div class="item-slick1 item1-slick1" style="background-image: url(images/banners/banner-1.jpg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 m-text1 t-center animated visible-false m-b-15" data-appear="fadeInDown">
							<?php echo e(trans('lang.women_collection')); ?>

						</span>

                        <h2 class="caption2-slide1 xl-text1 t-center animated visible-false m-b-37" data-appear="fadeInUp">
                            <?php echo e(trans('lang.new_arrival')); ?>
                ...
                <div class="item-slick1 item2-slick1" style="background-image: url(images/banners/banner-2.jpg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 m-text1 t-center animated visible-false m-b-15" data-appear="rollIn">
							<?php echo e(trans('lang.fur.collection')); ?>
                ...
                <div class="item-slick1 item3-slick1" style="background-image: url(images/banners/banner-3.jpg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 m-text1 t-center animated visible-false m-b-15" data-appear="rotateInDownLeft">
							<?php echo e(trans('lang.childern_collection')); ?>
                ...
                <div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
                    ...
                    <div class="block1 hov-img-zoom pos-relative m-b-30">
                        ...
                        <div class="block1-wrapbtn w-size2">
                            <!-- Button -->
                            <a href="#" class="flex-c-m size2 m-text2 bg3 hov1 trans-0-4">
                                <?php echo e(trans('lang.footwear')); ?>
                    ...
                    <div class="block2 wrap-pic-w pos-relative m-b-30">
                        ...
                        <div class="block2-content sizefull ab-t-l flex-col-c-m">
                            <h4 class="m-text4 t-center w-size3 p-b-8">
                               <?php echo e(trans('lang.signup_and_get_offer')); ?>

                            </h4>

                            <p class="t-center w-size4">
                                <?php echo e(trans('lang.be_first')); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="hov-img-zoom pos-relative">
                        ...
                        <div class="ab-t-l sizefull flex-col-c-m p-l-15 p-r-15">
							<span class="m-text9 p-t-45 fs-20-sm">
							     <?php echo e(trans('lang.beauty')); ?>

							</span>

                            <h3 class="l-text1 fs-35-sm">
                                <?php echo e(trans('lang.lookbook')); ?>

                            </h3>

                            <a href="#" class="s-text4 hov2 p-t-20 ">
                                <?php echo e(trans('lang.view_collection')); ?>n
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <section class="instagram p-t-20">
        <div class="sec-title p-b-52 p-l-15 p-r-15">
            <h3 class="m-text5 t-center">
                @ <?php echo e(trans('lang.instragm')); ?>
            ...
            <div class="block4 wrap-pic-w">
                ...
                <a href="#" class="block4-overlay sizefull ab-t-l trans-0-4">
                    ...
                    <div class="block4-overlay-txt trans-0-4 p-l-40 p-r-25 p-b-30">
                        ...
                        <span class="s-text9">
							<?php echo e(trans('lang.photo_by')); ?> @nancyward
						</span>
                    </div>
                </a>
            </div>
        ...
        <div class="flex-w p-l-15 p-r-15">
            <div class="flex-col-c w-size5 p-l-15 p-r-15 p-t-16 p-b-15 respon1">
                <h4 class="m-text12 t-center">
                    <?php echo e(trans('lang.free_delivery')); ?>

                </h4>

                <a href="#" class="s-text11 t-center">
                    <?php echo e(trans('lang.for_more_info')); ?>
            ...
            <div class="flex-col-c w-size5 p-l-15 p-r-15 p-t-16 p-b-15 bo2 respon2">
                <h4 class="m-text12 t-center">
                    <?php echo e(trans('lang.return_item')); ?>

                </h4>

                <span class="s-text11 t-center">
                    <?php echo e(trans('lang.exchange_item')); ?>
            ...
            <div class="flex-col-c w-size5 p-l-15 p-r-15 p-t-16 p-b-15 respon1">
                <h4 class="m-text12 t-center">
                    <?php echo e(trans('lang.store_open')); ?>

                </h4>

                <span class="s-text11 t-center">
                    <?php echo e(trans('lang.shop_open_days')); ?>
